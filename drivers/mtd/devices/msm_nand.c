...
uint32_t flash_read_id(struct msm_nand_chip *chip)
{
	...
	dsb();
	msm_dmov_exec_cmd(chip->dma_channel, crci_mask, DMOV_CMD_PTR_LIST | DMOV_CMD_ADDR
...
static struct flash_identification supported_flash[] =
{
	...
	{0x5580bcad, 0xFFFFFFFF, (512<<20), 1, 2048, (2048<<6), 64, }, /*Hynx*/
	{0x5510bcad, 0xFFFFFFFF, (512<<20), 1, 2048, (2048<<6), 64, }, /*Hynx*/
	{0x5590bc98, 0xFFFFFFFF, (512<<20), 1, 2048, (2048<<6), 64, }, /*Tosh*/
#else
	{0x5510bcad, 0xFFFFFFFF, (512<<20), 1, 2048, (2048<<6), 64, }, /*Hynx*/
	{0x5500bc98, 0x0000FFFF, (512<<20), 1, 2048, (2048<<6), 64, }, /*Tosh*/
	{0x5510bcad, 0xFFFFFFFF, (512<<20), 1, 2048, (2048<<6), 64, }, /*Hynx*/
#endif
...
int msm_nand_scan(struct mtd_info *mtd, int maxchips)
{
	...
	chip->CFG0 = (((mtd->writesize >> 9)-1) << 6) /* 4/8 cw/pg for 2/4k */
